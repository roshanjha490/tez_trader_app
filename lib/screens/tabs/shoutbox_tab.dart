...
class _ShoutboxTabState extends State<ShoutboxTab> {
  ...
  Future<void> _fetchOlderMessages() async {
    ...
    try {
      final response = await ApiClient.dio.get('/shoutbox/messages?offset=${_messages.length}');
      if (_isDisposed) return;
  ...
  Future<void> _sendMessage() async {
    ...
    try {
      ...
      if (response.data['success'] == true) {
        ...
        setState(() => _error = response.data['message'] ?? "Couldn't send message.");
      }
    } catch (e) {
      ...
      children: [
        ...
        Expanded(
          child: _messages.isEmpty && !_isLoadingOlder
              ? const Center(child: Text("No messages yet. Say something.", style: TextStyle(color: Colors.white54, fontSize: 13)))
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final lastInitial = (m['last_name']?.toString().isNotEmpty == true) 
                        ...
                        text: TextSpan(
                          ...
                          children: [
                            TextSpan(
                              ...
                              style: TextStyle(color: _getUserColor(userId), fontWeight: FontWeight.bold),
                            ),
                            TextSpan(
          ...
          Container(
            ...
            child: Wrap(
              ...
              children: _quickEmojis.map((emoji) => GestureDetector(
                onTap: () {
                  if (_draftController.text.length + emoji.length <= _maxLength) {
                ...
                children: [
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          IconButton(
                            icon: Icon(
                              _showEmojiPicker ? Icons.keyboard_arrow_down : Icons.emoji_emotions_outlined, 
                              color: _showEmojiPicker ? Colors.amberAccent : Colors.white54,
                              size: 20,
                            ),
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              decoration: const InputDecoration(
                                ...
                                counterText: "", // Hides the default counter to use our own
                              ),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      width: 48,
                      decoration: BoxDecoration(
                        color: _draftController.text.trim().isEmpty || _isSending 
